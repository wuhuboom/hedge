...
// ExamplereaderLookupStruct This example shows how to decode to a struct.  //这个例子展示了如何解码为结构体。
func ExamplereaderLookupStruct() {
...
// ExampleReader_NetworksWithin This example demonstrates how to iterate over all networks in the
